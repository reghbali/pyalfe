...
class Container(containers.DeclarativeContainer):
    ...
    skullstripping = providers.Singleton(
        ...
        pipeline_dir=pipeline_dir,
        modalities=config.options.modalities.as_(lambda s: s.plit(',')),
        overwrite=config.options.override_images
    )
    ...
    cross_modality_registration = providers.Singleton(
        ...
        pipeline_dir=pipeline_dir,
        modalities_all=config.options.modalities.as_(lambda s: s.plit(',')),
        modalities_target=config.options.target.as_(lambda s: s.plit(',')),
        overwrite=config.options.override_images
    )
    ...
    resampling = providers.Singleton(
        ...
        image_registration=image_registration,
        pipeline_dir=pipeline_dir,
        modalities_target=config.options.modalities.as_(lambda s: s.plit(',')),
        overwrite=config.options.override_images
    )
